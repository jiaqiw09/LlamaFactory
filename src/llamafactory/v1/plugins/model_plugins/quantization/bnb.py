...
if TYPE_CHECKING:
    from .interface import BnbParams


logger = logging.get_logger(__name__)


def _apply_bnb(init_kwargs: dict[str, Any], quant_config: "BnbParams", is_trainable: bool) -> dict[str, Any]:
...
def apply_bnb_quantization(
    init_kwargs: dict[str, Any], quant_config: "BnbParams", is_trainable: bool = False
) -> dict[str, Any]:
    return _apply_bnb(init_kwargs, quant_config, is_trainable=is_trainable)
